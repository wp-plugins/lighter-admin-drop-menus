...
function aws_header() 
{
	...
	echo '<link rel="stylesheet" type="text/css" href="' . $plugin_uri . '/wp-admin.css" />' . "\n";
	
	if ($is_winIE)
	{
		echo '<link rel="stylesheet" type="text/css" href="' . $plugin_uri . '/wp-admin-ie6.css" />';
	}
}
