...
* 2.6.7 This version includes Chinese translation! A million thanks go to [dupola](http://dupola.com) for the effort. Also: I fixe a pretty ugly bug that broke the effect of different color of the sidemenu with local version; I changed the aspect of the option page to make it more similar to the regular Wordpress 2.5 option pages; I fixed the removal of 'Help' and 'Forums' links, where local versions of Wordpress that personalized those links would broke the function; I added the option to remove the 'Howdy', too, although it does not work in the chinese version. While I was there I also redid the italian translation of the plugin, it was horrible. Now it is just a little less horrible. I can't believe how much the american IT lexicon sounds ugly in italian. Finally, once again thanks to [dupola](http://dupola.com) who made me notice a couple of oversights, including that the link to the plugin home page was mysteriously all scrambled. All should be fixed now.
