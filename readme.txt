...
3. Check out the options in the "Design" > "Lighter menus" page. You'll find a couple of little treasures.
4. Done. Enjoy.
...
* Farsi, thanks to [Mohammad Musavi](http://www.musavis.com)
* Romanian, thanks to [Dragos Nicolae](http://www.FreeSoftwareWorkshop.com)
...
* 2.7.5 This version is NOT compatible with the incoming Wordpress 2.7. I have doubts there ever will be one, anyway this is not it. That said, with this version I added a new option to display a 'Drafts' entry in the 'Manage' submenu! Hope this is welcome. I also fixed a few minor other things in the code. I have worked on it on the very far side, so nothing exceptional. Two new translations are avilable as well, in Farsi thanks to [Mohammad Musavi](http://www.musavis.com), and Romanian thanks to [Dragos Nicolae](http://www.FreeSoftwareWorkshop.com). IMPORTANT NOTE about translations: due to a recent PC disaster I lost all email messages and addresses of Lighter Menus translators. So if you submitted a new localization in the past, or want to make a updated one after this, please consider sending it again (my address is on [this page](http://www.italyisfalling.com/contact)). A thousand apologies. Thanks!
