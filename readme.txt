...
== Changelog ==
* 2.6.6 Corrected a pretty serious bug that prevented the new 2.5.1 media uploader to work with Lighter Menus. Now everything shoul get along finely. Also fixed the comment awaiting moeration message to incorrectly show up with 0 comments to moderate. Recommended.
